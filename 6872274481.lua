		...
		Function = function(callback) 
			...
			for i = 1, 10 do 
				...
				if callback then 
					...
					killaurabox.FillTransparency = 0.001
					...
					killaurabox.OutlineTransparency = 0.001
					killaurabox.Parent = GuiLibrary.MainGui
				else
					killaurabox = Instance.new("BoxHandleAdornment")
					killaurabox.Transparency = 0.001
...
AKey.BackgroundColor3 = Color3.fromRGB(255 ,0 ,0)
...
ALabel.Name = "ALabel"
ALabel.Parent = AKey
ALabel.BackgroundColor3 = Color3.fromRGB(255 ,0 ,0)
...
ALabel.Text = "A"
ALabel.TextColor3 = Color3.fromRGB(255 ,0 ,0)
ALabel.TextSize = 32.000

SKey.Name = "SKey"
SKey.Parent = keystroke
SKey.BackgroundColor3 = Color3.fromRGB(255 ,0 ,0)
...
SLabel.Name = "SLabel"
SLabel.Parent = SKey
SLabel.BackgroundColor3 = Color3.fromRGB(255 ,0 ,0)
...
DKey.BackgroundColor3 = Color3.fromRGB(255 ,0 ,0)
...
DLabel.Name = "DLabel"
DLabel.Parent = DKey
DLabel.BackgroundColor3 = Color3.fromRGB(255 ,0 ,0)
...
DLabel.Text = "D"
DLabel.TextColor3 = Color3.fromRGB(255 ,0 ,0)
DLabel.TextSize = 32.000

WKey.Name = "WKey"
WKey.Parent = keystroke
WKey.BackgroundColor3 = Color3.fromRGB(255 ,0 ,0)
...
WLabel.Name = "WLabel"
WLabel.Parent = WKey
WLabel.BackgroundColor3 = Color3.fromRGB(255 ,0 ,0)
...
WLabel.Text = "W"
WLabel.TextColor3 = Color3.fromRGB(255 ,0 ,0)
...
SpaceBarLabel.TextColor3 = Color3.fromRGB(191, 148, 228)
...
workspace.CurrentCamera.Viewmodel.ChildAdded:Connect(function(x)
    if x and x:FindFirstChild("Handle") then
        if string.find(x.Name:lower(), 'scythe , sword') then
            x.Handle.Material = "Neon"
