...
runFunction(function()
    ...
    FloatDisabler = GuiLibrary.ObjectsThatCanBeSaved.WizzwareWindow.Api.CreateOptionsButton({
        Name = "FloatDisabler",
        Function = function(callback)
            if callback then
    getgenv().FloatDisabler = true
...
getgenv().isnetworkowner = function(Ins)
return tick()
end
...
if getgenv().FloatDisabler == true then
